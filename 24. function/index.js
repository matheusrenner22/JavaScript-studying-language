...
var perimetroQuadrado = new Function('lado', 'return lado * 4');
...
var filtro = Array.prototype.filter.call(li, function(item) {
...
var filtro1 = Array.prototype.filter.call(li, itemPossuiAtivo);
var filtro2 = Array.prototype.filter.apply(li, [itemPossuiAtivo]);



// FUNCTION.BIND()
// diferente de call e apply, bind(this, arg1, arg2, ...) não irá executar a função mas sim retornar a mesma com o novo contexto do this.
var li = document.querySelectorAll('li');

var filtrarLi = Array.prototype.filter.bind(li, function(item) {
  return item.classList.contains('ativo');
});
...
var acelerarHonda = carro.acelerar.bind(honda);
acelerarHonda(200, 100);
...
function imc(altura, preco) {
  return peso / (altura * altura);
}

var imc180 = imc.bind(null, 1.80);
